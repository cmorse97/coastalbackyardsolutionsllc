export const teamData = [
  {
    ...
    description: "Enjoy a relaxing pool day and lay out in the sun!",
    socials: [
      {
        color: "purple",
        name: "instagram",
  ...
  },
  {
    ...
    description: "Nothing beats a nice cookout by the pool.",
    socials: [
      {
        color: "purple",
        name: "instagram",
  ...
  },
  {
    ...
    name: "Fire Pit",
    description: "Friday nights are about to get a whole lot warmer.",
    socials: [
      {
        color: "purple",
        name: "instagram",
  ...
  },
  {
    ...
    name: "Pool Remodel",
    description:
      "Out with the old and in with the new! Renovations are game changers!",
    socials: [
      {
        color: "purple",
        name: "instagram",
